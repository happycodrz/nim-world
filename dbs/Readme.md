...
- [FedericoCeratto/nim-lmdb](https://github.com/FedericoCeratto/nim-lmdb) - Nim LMDB wrapper <br/> (  / 12 commits / 25 stars )
- [GULPF/tiny_sqlite](https://github.com/GULPF/tiny_sqlite) - A thin SQLite wrapper for Nim <br/> (  / 17 commits / 8 stars )
...
- [juancarlospaco/nim-calibre](https://github.com/juancarlospaco/nim-calibre) - Calibre eBooks App Database Client for Nim. <br/> (  / 10 commits / 2 stars )
- [juancarlospaco/nim-gatabase](https://github.com/juancarlospaco/nim-gatabase) - Compile-Time ORM for Nim <br/> (  / 534 commits / 37 stars )
...
- [status-im/nim-rocksdb](https://github.com/status-im/nim-rocksdb) - Nim wrapper for RocksDB, a persistent key-value store for Flash and RAM Storage. <br/> (  / 50 commits / 20 stars )
- [ThomasTJdev/nim_sqlbuilder](https://github.com/ThomasTJdev/nim_sqlbuilder) - SQL builder for Nim queries <br/> (  / 8 commits / 5 stars )
<!-- /PROJECTS_LIST -->
...
- [juancarlospaco/nim-gatabase](https://github.com/juancarlospaco/nim-gatabase) - Compile-Time ORM for Nim <br/> (37 stars /  / 534 commits )
...
- [FedericoCeratto/nim-lmdb](https://github.com/FedericoCeratto/nim-lmdb) - Nim LMDB wrapper <br/> (25 stars /  / 12 commits )
- [status-im/nim-rocksdb](https://github.com/status-im/nim-rocksdb) - Nim wrapper for RocksDB, a persistent key-value store for Flash and RAM Storage. <br/> (20 stars /  / 50 commits )
- [Bennyelg/csvql](https://github.com/Bennyelg/csvql) - query CSVs in memory. with ansi sql <br/> (12 stars / 2019-12-13 / 38 commits )
- [GULPF/tiny_sqlite](https://github.com/GULPF/tiny_sqlite) - A thin SQLite wrapper for Nim <br/> (8 stars /  / 17 commits )
...
- [ThomasTJdev/nim_sqlbuilder](https://github.com/ThomasTJdev/nim_sqlbuilder) - SQL builder for Nim queries <br/> (5 stars /  / 8 commits )
...
- [juancarlospaco/nim-calibre](https://github.com/juancarlospaco/nim-calibre) - Calibre eBooks App Database Client for Nim. <br/> (2 stars /  / 10 commits )
<!-- /POPULARITY_LIST -->
